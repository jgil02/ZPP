    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Car>().HasData(
                ...
                new Car { IdCar = "C2", Brand = "BMW", Model = "3 Series", PricePerDay = 300, ImagePath = "/Images/BmwModel3.png", GearboxType = "Automatic", FuelType = "Petrol", BodyType = "Sedan", SeatsCount = 5, Segment = "D", DoorsCount = 4, TrunkCapacity = 480, EngineCapacity = 2.0 },
                new Car { IdCar = "C3", Brand = "Tesla", Model = "Model 3", PricePerDay = 450, ImagePath = "/Images/TeslaModel3.png", GearboxType = "Automatic", FuelType = "Electric", BodyType = "Sedan", SeatsCount = 5, Segment = "C", DoorsCount = 4, TrunkCapacity = 542, EngineCapacity = 0.0 },

                // SKODA
                new Car { IdCar = "C4", Brand = "Skoda", Model = "Octavia 3", PricePerDay = 180, ImagePath = "/Images/SkodaOctavia3.png", GearboxType = "Automatic", FuelType = "Petrol", BodyType = "Liftback", SeatsCount = 5, Segment = "C", DoorsCount = 5, TrunkCapacity = 610, EngineCapacity = 1.4 },
                ...
                new Car { IdCar = "C14", Brand = "Volkswagen", Model = "Golf 8", PricePerDay = 210, ImagePath = "/Images/VwGolf8.png", GearboxType = "Automatic", FuelType = "Hybrid", BodyType = "Hatchback", SeatsCount = 5, Segment = "C", DoorsCount = 5, TrunkCapacity = 381, EngineCapacity = 1.5 },
                ...
                new Car { IdCar = "C17", Brand = "Volkswagen", Model = "Passat 9", PricePerDay = 320, ImagePath = "/Images/VwPassat9.png", GearboxType = "Automatic", FuelType = "Diesel", BodyType = "Combi", SeatsCount = 5, Segment = "D", DoorsCount = 5, TrunkCapacity = 690, EngineCapacity = 2.0 },
                ...
                new Car { IdCar = "C24", Brand = "Audi", Model = "RS3", PricePerDay = 850, ImagePath = "/Images/AudiRS3.png", GearboxType = "Automatic", FuelType = "Petrol", BodyType = "Hatchback", SeatsCount = 5, Segment = "C", DoorsCount = 5, TrunkCapacity = 282, EngineCapacity = 2.5 },
                new Car { IdCar = "C25", Brand = "Audi", Model = "A4", PricePerDay = 300, ImagePath = "/Images/AudiA4.png", GearboxType = "Automatic", FuelType = "Diesel", BodyType = "Sedan", SeatsCount = 5, Segment = "D", DoorsCount = 4, TrunkCapacity = 460, EngineCapacity = 2.0 },
                ...
                new Car { IdCar = "C29", Brand = "Kia", Model = "Sportage", PricePerDay = 240, ImagePath = "/Images/KiaSportage.png", GearboxType = "Manual", FuelType = "Petrol", BodyType = "SUV", SeatsCount = 5, Segment = "SUV", DoorsCount = 5, TrunkCapacity = 591, EngineCapacity = 1.6 },
                ...
                new Car { IdCar = "C33", Brand = "Volvo", Model = "XC90", PricePerDay = 650, ImagePath = "/Images/VolvoXC90.png", GearboxType = "Automatic", FuelType = "Diesel", BodyType = "SUV", SeatsCount = 7, Segment = "SUV", DoorsCount = 5, TrunkCapacity = 640, EngineCapacity = 2.0 },
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=localhost;Initial Catalog=Wypożyczalnia;Integrated Security=True;Encrypt=True;Trust Server Certificate=True"); 
            }
        }
    }
}
